...
COMMENT ON COLUMN "user".ADDRESS IS '기본 주소';
COMMENT ON COLUMN "user".DETAILADDRESS IS '상세 주소';
...
CREATE TABLE WISHLIST (
    ...
    CONSTRAINT FK_WISHLIST_POSTID FOREIGN KEY (POSTID) REFERENCES PRODUCTPOST(POSTID),
    CONSTRAINT UK_WISHLIST_USER_POST UNIQUE (USERID, POSTID)
);
...
COMMENT ON COLUMN WISHLIST.POSTID IS '게시물ID (FK -> ProductPost)';
...
CREATE INDEX IDX_WISHLIST_POSTID ON WISHLIST(POSTID);
...
BEGIN
    IF INSERTING THEN
        -- 찜 추가 시: WISHCOUNT +1
        UPDATE PRODUCTPOST SET WISHCOUNT = NVL(WISHCOUNT, 0) + 1 WHERE POSTID = :NEW.POSTID;
    ELSIF DELETING THEN
        -- 찜 삭제 시: WISHCOUNT -1
        UPDATE PRODUCTPOST SET WISHCOUNT = NVL(WISHCOUNT, 0) - 1 WHERE POSTID = :OLD.POSTID;
    END IF;
END;
/
...
-- 주의: POSTID와 USERID가 실제로 존재하는 경우에만 실행
-- 게시물 9번 (POSTID 9) - 가장 인기: 5명이 찜
INSERT INTO WISHLIST (WISHLISTID, USERID, POSTID, CREATEDAT) 
SELECT SEQ_WISHLIST_WISHLISTID.NEXTVAL, 3, 9, SYSTIMESTAMP FROM DUAL
WHERE EXISTS (SELECT 1 FROM PRODUCTPOST WHERE POSTID = 9) 
  AND EXISTS (SELECT 1 FROM "USER" WHERE USERID = 3)
  AND NOT EXISTS (SELECT 1 FROM WISHLIST WHERE USERID = 3 AND POSTID = 9);

INSERT INTO WISHLIST (WISHLISTID, USERID, POSTID, CREATEDAT) 
SELECT SEQ_WISHLIST_WISHLISTID.NEXTVAL, 4, 9, SYSTIMESTAMP FROM DUAL
WHERE EXISTS (SELECT 1 FROM PRODUCTPOST WHERE POSTID = 9) 
  AND EXISTS (SELECT 1 FROM "USER" WHERE USERID = 4)
  AND NOT EXISTS (SELECT 1 FROM WISHLIST WHERE USERID = 4 AND POSTID = 9);

INSERT INTO WISHLIST (WISHLISTID, USERID, POSTID, CREATEDAT) 
SELECT SEQ_WISHLIST_WISHLISTID.NEXTVAL, 5, 9, SYSTIMESTAMP FROM DUAL
WHERE EXISTS (SELECT 1 FROM PRODUCTPOST WHERE POSTID = 9) 
  AND EXISTS (SELECT 1 FROM "USER" WHERE USERID = 5)
  AND NOT EXISTS (SELECT 1 FROM WISHLIST WHERE USERID = 5 AND POSTID = 9);

INSERT INTO WISHLIST (WISHLISTID, USERID, POSTID, CREATEDAT) 
SELECT SEQ_WISHLIST_WISHLISTID.NEXTVAL, 6, 9, SYSTIMESTAMP FROM DUAL
WHERE EXISTS (SELECT 1 FROM PRODUCTPOST WHERE POSTID = 9) 
  AND EXISTS (SELECT 1 FROM "USER" WHERE USERID = 6)
  AND NOT EXISTS (SELECT 1 FROM WISHLIST WHERE USERID = 6 AND POSTID = 9);

INSERT INTO WISHLIST (WISHLISTID, USERID, POSTID, CREATEDAT) 
SELECT SEQ_WISHLIST_WISHLISTID.NEXTVAL, 7, 9, SYSTIMESTAMP FROM DUAL
WHERE EXISTS (SELECT 1 FROM PRODUCTPOST WHERE POSTID = 9) 
  AND EXISTS (SELECT 1 FROM "USER" WHERE USERID = 7)
  AND NOT EXISTS (SELECT 1 FROM WISHLIST WHERE USERID = 7 AND POSTID = 9);

-- 게시물 10번 (POSTID 10) - 중간 인기: 3명이 찜
INSERT INTO WISHLIST (WISHLISTID, USERID, POSTID, CREATEDAT) 
SELECT SEQ_WISHLIST_WISHLISTID.NEXTVAL, 3, 10, SYSTIMESTAMP FROM DUAL
WHERE EXISTS (SELECT 1 FROM PRODUCTPOST WHERE POSTID = 10) 
  AND EXISTS (SELECT 1 FROM "USER" WHERE USERID = 3)
  AND NOT EXISTS (SELECT 1 FROM WISHLIST WHERE USERID = 3 AND POSTID = 10);

INSERT INTO WISHLIST (WISHLISTID, USERID, POSTID, CREATEDAT) 
SELECT SEQ_WISHLIST_WISHLISTID.NEXTVAL, 4, 10, SYSTIMESTAMP FROM DUAL
WHERE EXISTS (SELECT 1 FROM PRODUCTPOST WHERE POSTID = 10) 
  AND EXISTS (SELECT 1 FROM "USER" WHERE USERID = 4)
  AND NOT EXISTS (SELECT 1 FROM WISHLIST WHERE USERID = 4 AND POSTID = 10);

INSERT INTO WISHLIST (WISHLISTID, USERID, POSTID, CREATEDAT) 
SELECT SEQ_WISHLIST_WISHLISTID.NEXTVAL, 5, 10, SYSTIMESTAMP FROM DUAL
WHERE EXISTS (SELECT 1 FROM PRODUCTPOST WHERE POSTID = 10) 
  AND EXISTS (SELECT 1 FROM "USER" WHERE USERID = 5)
  AND NOT EXISTS (SELECT 1 FROM WISHLIST WHERE USERID = 5 AND POSTID = 10);

-- 게시물 11번 (POSTID 11) - 높은 인기: 4명이 찜
INSERT INTO WISHLIST (WISHLISTID, USERID, POSTID, CREATEDAT) 
SELECT SEQ_WISHLIST_WISHLISTID.NEXTVAL, 3, 11, SYSTIMESTAMP FROM DUAL
WHERE EXISTS (SELECT 1 FROM PRODUCTPOST WHERE POSTID = 11) 
  AND EXISTS (SELECT 1 FROM "USER" WHERE USERID = 3)
  AND NOT EXISTS (SELECT 1 FROM WISHLIST WHERE USERID = 3 AND POSTID = 11);

INSERT INTO WISHLIST (WISHLISTID, USERID, POSTID, CREATEDAT) 
SELECT SEQ_WISHLIST_WISHLISTID.NEXTVAL, 4, 11, SYSTIMESTAMP FROM DUAL
WHERE EXISTS (SELECT 1 FROM PRODUCTPOST WHERE POSTID = 11) 
  AND EXISTS (SELECT 1 FROM "USER" WHERE USERID = 4)
  AND NOT EXISTS (SELECT 1 FROM WISHLIST WHERE USERID = 4 AND POSTID = 11);

INSERT INTO WISHLIST (WISHLISTID, USERID, POSTID, CREATEDAT) 
SELECT SEQ_WISHLIST_WISHLISTID.NEXTVAL, 6, 11, SYSTIMESTAMP FROM DUAL
WHERE EXISTS (SELECT 1 FROM PRODUCTPOST WHERE POSTID = 11) 
  AND EXISTS (SELECT 1 FROM "USER" WHERE USERID = 6)
  AND NOT EXISTS (SELECT 1 FROM WISHLIST WHERE USERID = 6 AND POSTID = 11);

INSERT INTO WISHLIST (WISHLISTID, USERID, POSTID, CREATEDAT) 
SELECT SEQ_WISHLIST_WISHLISTID.NEXTVAL, 7, 11, SYSTIMESTAMP FROM DUAL
WHERE EXISTS (SELECT 1 FROM PRODUCTPOST WHERE POSTID = 11) 
  AND EXISTS (SELECT 1 FROM "USER" WHERE USERID = 7)
  AND NOT EXISTS (SELECT 1 FROM WISHLIST WHERE USERID = 7 AND POSTID = 11);

-- 게시물 12번 (POSTID 12) - 낮은 인기: 2명이 찜
INSERT INTO WISHLIST (WISHLISTID, USERID, POSTID, CREATEDAT) 
SELECT SEQ_WISHLIST_WISHLISTID.NEXTVAL, 3, 12, SYSTIMESTAMP FROM DUAL
WHERE EXISTS (SELECT 1 FROM PRODUCTPOST WHERE POSTID = 12) 
  AND EXISTS (SELECT 1 FROM "USER" WHERE USERID = 3)
  AND NOT EXISTS (SELECT 1 FROM WISHLIST WHERE USERID = 3 AND POSTID = 12);

INSERT INTO WISHLIST (WISHLISTID, USERID, POSTID, CREATEDAT) 
SELECT SEQ_WISHLIST_WISHLISTID.NEXTVAL, 5, 12, SYSTIMESTAMP FROM DUAL
WHERE EXISTS (SELECT 1 FROM PRODUCTPOST WHERE POSTID = 12) 
  AND EXISTS (SELECT 1 FROM "USER" WHERE USERID = 5)
  AND NOT EXISTS (SELECT 1 FROM WISHLIST WHERE USERID = 5 AND POSTID = 12);

-- 게시물 13번 (POSTID 13) - 매우 낮은 인기: 1명만 찜
INSERT INTO WISHLIST (WISHLISTID, USERID, POSTID, CREATEDAT) 
SELECT SEQ_WISHLIST_WISHLISTID.NEXTVAL, 4, 13, SYSTIMESTAMP FROM DUAL
WHERE EXISTS (SELECT 1 FROM PRODUCTPOST WHERE POSTID = 13) 
  AND EXISTS (SELECT 1 FROM "USER" WHERE USERID = 4)
  AND NOT EXISTS (SELECT 1 FROM WISHLIST WHERE USERID = 4 AND POSTID = 13);
